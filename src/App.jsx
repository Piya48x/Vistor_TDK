...
export default function App() {
  ...
  const resetForm = () => {
    setForm({ full_name: "", company: "", phone: "", contact_person: "", purpose: "ประชุมงาน", other_purpose: "" });
    setPhotoDataUrl("");
        ...
        <div className="card-body">
          ...
          {step === 2 && (
            <form onSubmit={handleSubmit} className="fade">
              <h2 style={{textAlign: 'center', marginTop: 0, fontSize: '20px'}}>ข้อมูลผู้มาติดต่อ</h2>
              
              <div className="input-group">
                <label>ชื่อ-นามสกุล</label>
                <input required placeholder="ระบุชื่อผู้ติดต่อ" value={form.full_name} onChange={e => setForm({...form, full_name: e.target.value})} />
              </div>

              <div className="input-group">
                <label>มาจากบริษัท / หน่วยงาน</label>
                <input required placeholder="ชื่อบริษัทของคุณ" value={form.company} onChange={e => setForm({...form, company: e.target.value})} />
              </div>
              ...
              <div className="input-group">
                ...
                <input required placeholder="ชื่อเจ้าหน้าที่ TDK" value={form.contact_person} onChange={e => setForm({...form, contact_person: e.target.value})} />
              </div>
              ...
              {form.purpose === "อื่น ๆ" && (
                <div className="input-group fade">
                  ...
                  <input required placeholder="ระบุเหตุผลการเข้าพบ" value={form.other_purpose} onChange={e => setForm({...form, other_purpose: e.target.value})} />
                </div>
              )}
          ...
          {step === 3 && (
            <div className="success-hero fade">
              ...
              <p style={{color: '#718096', lineHeight: 1.6}}>
                บันทึกข้อมูลเข้าพื้นที่เรียบร้อยแล้ว<br/>กรุณารอรับบัตร Visitor จากเจ้าหน้าที่
              </p>
